...
<!--There is something missing in the description ("files" and "registers" after the numbers).-->
...
<!--Yes! In a separate script documented in the README, not everything computing in the QMD.-->
...
<!--Also: quotes should have page numbers when the source has page numbering.-->
